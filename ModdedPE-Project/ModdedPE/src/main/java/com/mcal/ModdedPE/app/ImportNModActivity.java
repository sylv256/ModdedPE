	...
	private class UIHandler extends Handler
	{
		...
		public void handleMessage(Message msg)
		{
			...
			else if (msg.what == MSG_FAILED)
			{
				...
				errorText.setText(getString(R.string.nmod_import_failed_full_info_message, new String[]{archiveFailedException.toTypeString(),archiveFailedException.getCause().toString()}));
			}
		}
	}
}
