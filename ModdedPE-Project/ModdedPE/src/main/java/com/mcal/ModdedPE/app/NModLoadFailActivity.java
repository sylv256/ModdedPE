...
public class NModLoadFailActivity extends BaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		mPackageNames = getIntent().getExtras().getStringArrayList(KEY_TYPE_STRING);
	...
	private class ViewAdapter extends BaseAdapter
	{
		...
		public View getView(int p1, View p2, ViewGroup p3)
		{
			...
			AppCompatTextView errorMessageTextView = (AppCompatTextView)view.findViewById(R.id.moddedpe_nmod_load_failed_item_card_package_name);
	...
	public static void startThisActivity(Activity context, ArrayList<NMod> nmods)
	{
